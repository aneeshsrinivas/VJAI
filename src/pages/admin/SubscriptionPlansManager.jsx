...
const defaultPlans = [
    {
        ...
        description: 'Personal coaching for beginners',
        price: 60,
        billingCycle: 'MONTHLY',
        level: 'beginner',
        duration: '1',
        features: ['Dedicated coach assignment', 'Personalized lesson plans', '4 sessions/month', 'Progress tracking'],
        isActive: true, isFeatured: false, sortOrder: 0
    },
    {
        id: 'beginner-3m',
        name: 'Beginner — 3 Months',
        description: 'Personal coaching for beginners (3 months)',
        price: 160,
        billingCycle: 'QUARTERLY',
        level: 'beginner',
        duration: '3',
        features: ['Dedicated coach assignment', 'Personalized lesson plans', '12 sessions total', 'Progress tracking'],
        isActive: true, isFeatured: false, sortOrder: 1
    },
    {
        id: 'beginner-4m',
        name: 'Beginner — 4 Months',
        description: 'Personal coaching for beginners (4 months)',
        price: 200,
        billingCycle: 'QUARTERLY',
        level: 'beginner',
        duration: '4',
        features: ['Dedicated coach assignment', 'Personalized lesson plans', '16 sessions total', 'Progress tracking'],
        isActive: true, isFeatured: false, sortOrder: 2
    },
    {
        id: 'advanced-beginner-1m',
        name: 'Advanced Beginner — 1 Month',
        description: 'Personal coaching for advanced beginners',
        price: 60,
        billingCycle: 'MONTHLY',
    ...
    },
    {
        ...
        description: 'Personal coaching for advanced beginners (3 months)',
        price: 160,
        billingCycle: 'QUARTERLY',
        level: 'advanced-beginner',
        duration: '3',
    ...
    },
    {
        ...
        description: 'Personal coaching for advanced beginners (4 months)',
        price: 200,
        billingCycle: 'QUARTERLY',
        level: 'advanced-beginner',
        duration: '4',
