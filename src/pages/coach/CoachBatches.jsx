...
const CoachBatches = () => {
    ...
    // Fetch Batches for current coach
    useEffect(() => {
        ...
        const unsubscribe = onSnapshot(q, (snapshot) => {
            const batchList = snapshot.docs.map(d => ({ id: d.id, ...d.data() }));
    ...
    // Note: Student counts are currently not dynamically synced to batch documents in real-time here
    // But the batch list itself is dynamic.
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#64748b', fontSize: '14px' }}>
                                            <div style={{
                                                ...
                                                <Users size={16} color={batch.color || '#3b82f6'} />
                                            </div>
                                            <span>{batch.level || 'General'}</span>
                                        </div>
                                    </div>
                                </div>
