...
const ClassDetailsModal = ({ isOpen, onClose, classData }) => {
    ...
    return (
        <div style={{
            ...
            <div style={{
                background: isDark ? '#1a1d27' : 'white', padding: '24px', borderRadius: '20px',
                width: '100%', maxWidth: '450px', boxShadow: isDark ? '0 20px 40px rgba(0,0,0,0.5)' : '0 20px 40px rgba(0,0,0,0.2)',
                maxHeight: '90vh', overflowY: 'auto',
                color: isDark ? '#f0f0f0' : 'inherit'
            }} onClick={e => e.stopPropagation()}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                    <h2 style={{ margin: 0, fontSize: '20px', color: isDark ? '#f0f0f0' : '#1e293b' }}>Class Details</h2>
                ...
                <div style={{ marginBottom: '24px' }}>
                    <h3 style={{ margin: '0 0 8px', fontSize: '18px', color: isDark ? '#60a5fa' : '#3b82f6' }}>{classData.title}</h3>
                ...
                <div style={{ borderTop: `1px solid ${isDark ? 'rgba(255,255,255,0.1)' : '#e2e8f0'}`, paddingTop: '20px' }}>
                    <h4 style={{ margin: '0 0 16px', fontSize: '16px', color: isDark ? '#f0f0f0' : '#1e293b' }}>Upload Assignment</h4>
                    <form onSubmit={handleUpload}>
                        <div style={{ marginBottom: '16px' }}>
                            <label style={{ display: 'block', fontSize: '13px', fontWeight: '600', marginBottom: '6px', color: isDark ? '#cbd5e1' : '#475569' }}>Assignment Title</label>
                            <input
                                type="text"
                                required
                                ...
                                style={{ width: '100%', padding: '10px', borderRadius: '8px', border: `1px solid ${isDark ? 'rgba(255,255,255,0.1)' : '#cbd5e1'}`, background: isDark ? 'rgba(255,255,255,0.05)' : 'white', color: isDark ? '#f0f0f0' : 'inherit' }}
                            />
                        </div>
